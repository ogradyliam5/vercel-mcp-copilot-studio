  ...
  switch (method) {
    ...
    case "tools/call": {
      ...
      try {
        ...
        if (Buffer.byteLength(JSON.stringify(value) ?? "null") > MAX_RESULT_BYTES) throw new Error("Result exceeds 524288 bytes; narrow the query. Do not retry a write without checking its state.");
