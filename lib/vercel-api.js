...
async function request(token, method, path, query, body, origin = API) {
  ...
  if (origin === API && path.startsWith("/v1/registrar/") && query?.teamId && !query.teamId.startsWith("team_")) throw new Error("Registrar APIs require an actual team_ ID, not a slug");
